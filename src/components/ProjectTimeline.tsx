...
const stages: TimelineStage[] = [
  {
    stage: 1,
    title: "Analizar, Aprender y Planificar",
    dates: "4 de Septiembre al 2 de Octubre",
    objective: "Elección de oportunidades de mejora y establecimiento de las bases del proyecto",
    icon: <Lightbulb className="h-8 w-8" />,
  },
  {
    stage: 2,
    title: "Mejorar e Implementar",
    dates: "2 de Octubre al 20 de Noviembre",
    objective: "Análisis de causa raíz, ideación de la solución e implementación con resultados medibles",
    icon: <CheckCircle className="h-8 w-8" />,
  },
  {
    stage: 3,
    title: "Controlar y Estandarizar",
    dates: "20 de Noviembre al 11 de Diciembre",
    objective: "Formalizar la mejora para mantener los procesos en el tiempo",
...
const ProjectTimeline = () => {
  return (
    <div className="space-y-8">
      <h2 className="text-3xl font-bold text-center mb-8 text-primary">Ruta de Implementación</h2>
