...
const stages: TimelineStage[] = [
  {
    stage: 1,
    title: "Fase 1: Diagnóstico, Mapeo de Flujo (VSM) y Definición de Requisitos",
    objective: "Levantamiento del flujo actual de logística interna y expedición, identificación de cuellos de botella y diseño del estado futuro bajo metodología Lean-Agile.",
    icon: <Lightbulb className="h-8 w-8" />,
  },
  {
    stage: 2,
    title: "Fase 2: Diseño del Modelo Operativo y Desarrollo de Solución Digital",
    objective: "Estandarización de procedimientos de picking, embalaje y despacho, diseño de arquitectura de datos e integración con el ecosistema de sistemas de planta.",
    icon: <CheckCircle className="h-8 w-8" />,
  },
  {
    stage: 3,
    title: "Fase 3: Implementación Piloto, Capacitación y Despliegue",
    objective: "Puesta en marcha en piso de planta, capacitación a personal operativo y líderes de logística, y estabilización del modelo con medición continua de OTIF.",
    icon: <Calendar className="h-8 w-8" />,
  },
];

const ProgressTimelineExp = () => {
  return (
...
export default ProgressTimelineExp;
